...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Oluremi Tinubu Free Medical Outreach" },
      { name: "description", content: "Free, quality medical care for underserved communities across Nigeria. Powered by HASO Rock." },
      { property: "og:site_name", content: "Oluremi Tinubu Free Medical Outreach" },
